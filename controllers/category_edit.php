...
<html lang="en">
  ...
  <div class="wrapper">
      ...
      <?php if(count($errors)>0):?>
			   ...
			   <?php endif; ?>
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Kategori Düzenleme</h2>
           
            <?php
           if(isset($_POST['editc-btn'])){
               //echo "jkolpğüğpokjhbjk";
                $cid= $_POST['edit_cid'];
            ...
            <input type="hidden" name="edit_cid" value="<?php echo $row['cid']?>">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="edit_cname" class="form-control" value=<?php echo $row['cname']?>  placeholder="Ürününüz Adı">
                  </div>
                    ...
                    <div class="modal modal-blur fade"></div>
                      ...
                      <div class="col-lg-8">
                      <div class="mb-3">
                          <label><input type="checkbox" name="edit_checksC"  value=<?php echo $row['checksC']?> /> Menüde gözüksün</label>
                  ...
                  <div class="row">
                   <div class="col-lg-12">
                    <div>
                        ...
                        <textarea class="form-control" name="edit_cinfo"  rows="3"><?php echo $row['cinfo']?></textarea>
                    </div>
                   </div>
                  </div>
                </div>

                <a href="../admin/category.php" class="btn btn-danger">İptal</a>  
                <button type="submit" name="updatec-btn" class= "btn btn-primary">Güncelle</button>
