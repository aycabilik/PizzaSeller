...
<html lang="en">
  ...
  <div class="wrapper">
      ...
      <div class="container-tight py-4">
          ...
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Admin Düzenleme</h2>
                  ...
                  ?>
                    ...
                    <form action="add.php" method = "POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="edit_name" class="form-control" value=<?php echo $row['username']?> class="form-control" placeholder="Ürününüz Adı">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="text" name="edit_email" class="form-control" value=<?php echo $row['email']?> class="form-control" placeholder="Ürününüz Adı">
                      </div>

                        <a href="../admin/admin.php" class="btn btn-danger">İptal</a>  
                        <button type="submit" name="updateAd-btn" class= "btn btn-primary">Güncelle</button>
