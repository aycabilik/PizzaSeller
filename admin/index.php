        ...
        <div class="modal-dialog modal-lg" role="document">
         ...
         <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="pname" class="form-control" placeholder="Ürününüz Adı">
            </div>
            <div class="mb-3">
              <label class="form-label">Ürün Ücreti</label>
              <input type="text"name="pcost"  class="form-control"  placeholder="Ürününüz Ücreti">
            </div>
            <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="mb-3">
                 ...
                 <label><input type="checkbox" name="check"/> Menüde gözüksün</label>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="login-btn" class="btn btn-primary ms-auto" data-bs-dismiss="modal">
              <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
              Ürünü Ekle
            </button>
            ...
            <div class="row row-deck row-cards">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Kullanıcı Sayısı</div>
                    ...
                    <?php 
                          ...
                          $queryR= "SELECT id from users ORDER BY id";
                          $query_run = mysqli_query($pro,$queryR);
                          $rowR = mysqli_num_rows($query_run);
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Ürün Sayısı</div>
                    ...
                    <?php 
                          ...
                          $query_run1 = mysqli_query($pro,$query);
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Toplam Kazanç</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
