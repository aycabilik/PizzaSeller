...
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div class="page page-center">
      ...
      <form class="card card-md" action="newp.php" method="post" autocomplete="off">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Yeni Ürün</h2>
            ...
            <div class="mb-3">
              ...
              <select name="cname"  class=form-select> 
            ...
            <div class="mb-3">
              ...
              <input type="text" name="pname" value="<?php echo $pname;?>" class="form-control" placeholder="Ürününüz Adı">
            </div>
            <div class="mb-3">
              <label class="form-label">Ürün Ücreti</label>
              <input type="text"name="pcost" value="<?php echo $pcost; ?>" class="form-control"  placeholder="Ürününüz Ücreti">
            </div>
            <div class="mb-3">
              <label class="form-label">İndirimli Ücret</label>
              <input type="text" name="pdisc"  class="form-control" placeholder="Ürününüz indirimli ücreti">
            </div>
            <div class="mb-3">
              <label class="form-label">Ürün fotoğrafı-1</label>
              <input type="file" name="pimage1"  id="pimage1" class="form-control" />
            </div>
            <!-- <div class="mb-3">
              <label class="form-label">Ürün fotoğrafı-2</label>
              <input type="file" name="pimage2" value=" class="form-control" >
            </div> -->
                 ...
                 <div class="col-lg-8"> </div>
                   <div class="col-lg-8">
                    <div class="mb-3">
                        ...
                        <label><input type="checkbox" name="checks" value=1>
                                <//input type= "hidden" id="checks" name="checks" value="0"/> Menüde gözüksün</label>
             ...
             <div class="row">
              <div class="col-lg-12">
                <div>
                  ...
                  <textarea class="form-control" name="pinfo" rows="3"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <a href="index.php" class="btn btn-link link-secondary" data-bs-dismiss="modal">
              İptal
            </a>
            <button type="submit" name="add-btn" class="btn btn-primary ms-auto" data-bs-dismiss="modal">
