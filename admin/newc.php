...
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div class="page page-center">
      ...
      <form class="card card-md" action="newc.php" method="post" autocomplete="off">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Yeni Kategori</h2>
            ...
            <div class="mb-3">
              ...
              <input type="text" name="cname" class="form-control" placeholder="Ürününüz Adı">
            </div>
                 ...
                 <div class="col-lg-8"> </div>
                   <div class="col-lg-8">
                    <div class="mb-3">
                        ...
                        <label><input type="checkbox" name="checksC" value=1>
             ...
             <div class="row">
              <div class="col-lg-12">
                <div>
                  ...
                  <textarea class="form-control" name="cinfo" rows="3"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <a href="category.php" class="btn btn-link link-secondary" data-bs-dismiss="modal">
              İptal
            </a>
            <button type="submit" name="addc-btn" class="btn btn-primary ms-auto" data-bs-dismiss="modal">
