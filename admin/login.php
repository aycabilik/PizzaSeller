    ...
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card card-md" action="login.php" method="post" autocomplete="off">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Üye Girişi</h2>
        	...
        	<div class="mb-2">
				<label class="form-label" for="username">Kullanıcı adı ya da e-Mail</label>
				<input type="text" name="username" value="<?php echo $username ?>" placeholder="Kullanıcı adı/ e-mail" class="form-control">
			</div>
			
            <div class="mb-2">
              <label class="form-label"for="password">Şifre
            ...
            <div class="form-footer">
              <button type="submit" name="login-btn"class="btn btn-primary w-100">Giriş</button>
            </div>
          </div>
		...
		Üye değil misin? <a href="register.php" tabindex="-1">Kayıt ol</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
