            ...
            <div class="row align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  ...
                  <a href="newp.php" class="btn btn-primary d-none d-sm-inline-block">
                  ...
                  <div class="table-responsive">
                    <table
                      ...
                      <thead>
                        ...
                        <th>ürün ismi</th>
                        <th>ürün ücreti</th>
                        <th>indirimli ürün ücreti</th>
                        <th>ürün fotoğrafı-1</th>
                        <th>ürün fotoğrafı-2</th>
                      ...
                      <?php
                          ...
                          <tr>
                             ...
                             <td> <?php echo '<img src= "product_image/'.$row['pimage1'].'" width="100px;" height="100px;" alt="pimage1"> '?></td>
                            
                             <td ><?php echo $row['pimage2'];?></td>
                             <td ><?php echo $row['checks'];?></td>
                             <td ><?php echo $row['pinfo'];?></td>
                             <td>
                               <form action="../controllers/product_edit.php" method="post">
                                  <input type="hidden" name="edit_id"   value="<?php echo $row['id'];?>">
                                  <button type="submit" name="edit-btn" class= "btn btn-success" >Düzenle</button>                               
                               </form>
                             </td>
                             <td>
                                <form  method="post">
                                    <input type="hidden" name="delete_id"   value="<?php echo $row['id'];?>">
                                    <button type="submit" name="delete-btn" data-toggle="modal" class="btn btn-danger">Sil</button>
                               </form>
                            </td>
                           </tr> 
                           <?php }
                          ...
                          <input type="hidden" name="delete_id"   value="<?php echo $id;?>">
                           <button type="submit" name="del_data" class="btn btn-primary" >Sil </button>
                          </form> 
                          <?php
                          }
                           ?>      
