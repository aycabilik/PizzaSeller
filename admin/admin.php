            ...
            <div class="row align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  ...
                  <a href="newad.php" class="btn btn-primary d-none d-sm-inline-block">
		...
		class="table table-vcenter card-table">
                 ...
                 <?php
                   ...
                   <tr>
                             ...
                             <td>
                               <form action="../controllers/admin_edit.php" method="post">
                                  <input type="hidden" name="edit_id"   value="<?php echo $row['id'];?>">
                                  <button type="submit" name="editAd-btn" class= "btn btn-success" >Düzenle</button>                               
                               </form>
                             </td>
                             <td>
                                <form  method="post">
                                    <input type="hidden" name="delete_id"   value="<?php echo $row['id'];?>">
                                    <button type="submit" name="deleteAd-btn" class="btn btn-danger">Sil</button>
                               </form>
                            </td>
                        </tr>  
                        <?php
                 ...
                 <div class="modal-body"
                  ...
                  <input type="hidden" name="delete_id"   value="<?php echo $id;?>">
                    <button type="submit" name="delAp_data" class="btn btn-primary" >Sil </button>
                  </form> 
                  <?php
                  }
                    ?>      
