  ...
  <body class="antialiased border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card card-md" action="newad.php" method="post">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Admin Kayıt Ekranı</h2>
            ...
            <div class="mb-2">
					<label class="form-label"for="username">Admin kullanıcı adı</label>
        ...
        <div class="mb-2">
            ...
            <div class="form-footer">
              <button type="submit" name="signupAd-btn" class="btn btn-primary w-100">Admin Ekle</button>
            </div>
          </div>
        </form>       
      </div>
